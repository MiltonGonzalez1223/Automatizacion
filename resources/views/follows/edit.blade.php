...
<div class="container mt-3">
  ...
  <form action="{{route('suppliers.update', $suppliers->Acreedor)}}" method="POST">
    ...
    <div class="form-floating mb-3 mt-3">
      <input type="text" class="form-control" id="name"  value="{{$suppliers->Nombre_proveedor}}" name="name">
      <label for="name">Nombre del proveedor</label>
    </div>
    <div class="form-floating mb-3 mt-3">
      <select value="{{$suppliers->Moneda_Pago}}" name="moneda" id="" class="form-select  ">
